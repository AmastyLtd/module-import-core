...
use Amasty\ImportCore\Import\DataHandling\FieldModifier\Replace;
...
/**
 * @covers \Amasty\ImportCore\Import\DataHandling\FieldModifier\Replace
 */
class ReplaceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->modifier = new Replace([], $this->argumentsConverterMock);
    }
    ...
    public function transformDataProvider(): array
    {
        return [
            ...
            ['Some text', ['from_input_value' => 'Some'], ' text'],
            ['Some text', ['from_input_value' => 'Some', 'to_input_value' => 'new'], 'new text']
        ];
    }
