...
use Amasty\ImportCore\Import\DataHandling\FieldModifier\Number\Plus;
...
/**
 * @covers \Amasty\ImportCore\Import\DataHandling\FieldModifier\Number\Plus
 */
class PlusTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->modifier = new Plus([], $this->argumentsConverterMock);
    }
    ...
    {
        $reflection = new \ReflectionClass(Plus::class);
