...
use Amasty\ImportCore\Import\DataHandling\FieldModifier\Number\Multiple;
...
/**
 * @covers \Amasty\ImportCore\Import\DataHandling\FieldModifier\Number\Multiple
 */
class MultipleTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->modifier = new Multiple([], $this->argumentsConverterMock);
    }
    ...
    {
        $reflection = new \ReflectionClass(Multiple::class);
